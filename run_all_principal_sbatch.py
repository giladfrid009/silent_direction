...
def layer_short_tag(layer_path: str) -> str:
    ...
    Examples:
        model.layers.4          -> L4
        model.layers.4.self_attn -> L4-self_attn
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Submit consolidated IML principal experiments via SLURM sbatch.")
    ...
    # SLURM options
    parser.add_argument("--gpu", type=str, default="1", help="GPU resource for --gres (e.g. '1', 'A100:1', 'PRO6000:1').")
    ...
    print(f"🚀 Submitting IML principal jobs for models: {target_models}")
    if args.dry_run:

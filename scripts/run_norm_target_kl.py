...
from src.norm_target_kl.train import train_norm_targeted_kl
from scripts.experiment import Experiment


class TargetNormKLExperiment(Experiment):
    ...
    def run_training(
        ...
        direction, history = train_norm_targeted_kl(
...
if __name__ == "__main__":
    experiment = TargetNormKLExperiment()
    experiment.main()

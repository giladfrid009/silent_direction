...
PROJECT_NAME = "silent-norm-dual-v1"
SCRIPT_PATH = "scripts/run_norm_dual.py"
...
MODELS = {
    "llama-2-7b-chat": {
        "experiments": {
            # "KL-0.001": {**EXP_SETUP_KL_001, **{"target_kl": 0.001}},
            ...
            "KL-0.025": {**EXP_SETUP_KL_001, **{"target_kl": 0.025}},
            # "KL-0.05": {**EXP_SETUP_KL_001, **{"target_kl": 0.05}},
            # "KL-0.1": {**EXP_SETUP_KL_001, **{"target_kl": 0.1}},
